...
export const AdminDashBoard = ({history}) => {
  ...
  return (
    ...
    marginBottom: "3vh" }}>
        <span style={{
    marginRight: "30px" }}>Admin Dashboard</span>
        <span>
  ...
  anchorEl = {anchorEl} keepMounted
    ...
    style =
        {{ marginBottom: "3vh" }} >
            <span style = {{ marginRight: "30px" }}>Patient Trend of your center<
                /span>
            ...
            datasets: [
              {
                ...
                data : Object.keys(scheduledOrVaccinatedPatients)
                           .map((day) => registeredPatients["vaccinated"][day]
                                             ?.length ||
                                         0),
                borderColor : "#00e600",
              ...
              },
              {
                ...
                data :
                    Object.keys(registeredPatients["scheduled"])
                        .map((day) =>
    ...
    marginBottom: "3vh" }}
        >
          <span style={{
    marginRight: "30px" }}>Patient Details</span>
          <span style={{ fontSize: "16px", color: "#5c5c8a" }}>
            Last&nbsp;
            <TextField
              variant="outlined"
  ...
  direction = "row"
  xs = {12} spacing = {2} key = {
      `${Math.random() * 10000}${date}${state}`} justify = "center"
  alignItems = "center" > <Grid item>
               <Typography variant =
                    "subtitle1" color =
                        "textSecondary"><b>Date of vaccination: </b>&nbsp;{date}
                        </Typography></Grid>
                      <Grid
                        item
                        container
                   ...
                   firstName + " " +
                   lastName}</Typography>
                                </Grid><Grid item xs = {12}><Typography variant = "body1"><b style = {
                 { marginRight: "7px" }
               }>Location</b>
                                ...
                                <Grid item xs={12}>
                                  <Typography variant="body1">
                                    <b style={{ marginRight: "7px" }}>Email</b>< a
  style =
  {
    { textDecoration: "none", color: "grey", }
      ...
      {email}</a>
          ...
          (<Grid item xs = {12}><Typography variant = "body1">
           <b style = {{ marginRight: "7px" }}>Time slot<
               /b>
                                      {vaccinationTimeSlot}
                                    </Typography>
           </Grid>
